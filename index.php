...
<body>
    ...
    <header style="text-align: center;">
        <div class="jasa pengiriman" id="Jasa Pengiriman">
            <br>
            <h1><span class="efek-ngetik"></span></h1>
    </b>
    <form name="input"  method="POST" action="proses.php">
        <table border="0" bgcolor=#f3971b width="50%" cellpadding="5" cellspacing="0" align="center">
            ...
            <tr>
                ...
                <td> <input type="text" name="jarak" size="30"/> </td>
            </tr>
            <tr>
                <td>Alamat</td><td> : </td>
            ...
            <tr>
                ...
                <td> <input type="text" name="berat" size="30/"> </td>
                </td>
            </tr>
            <tr>
                <td colspan="3" align="right">
                    <input type="submit" value="Hitung" onclick="hitungtotal()">
